...
val immf: float -> (float list) ref ->[>] operand
val movsd: [`D] operand -> [`D] register ->  text
val pushsd: [`D] operand ->  text
val popsd:  [`D] register ->  text

val cvtsi2sdq: [`Q] operand -> [`D] register ->  text
val cvttsd2siq: [`D] operand -> [`Q] register ->  text

val addsd : [`D] operand -> [`D] register -> text
val subsd : [`D] operand -> [`D] register -> text
val mulsd : [`D] operand -> [`D] register -> text
val divsd : [`D] register -> [`D] operand -> text